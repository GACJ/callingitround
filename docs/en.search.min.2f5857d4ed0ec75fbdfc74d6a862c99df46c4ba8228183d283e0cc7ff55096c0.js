...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.19efb51aff714143de2b241faa4def01436e643c2669767b60adbe6adc210355.js',function(){input.required=false;search();});}
