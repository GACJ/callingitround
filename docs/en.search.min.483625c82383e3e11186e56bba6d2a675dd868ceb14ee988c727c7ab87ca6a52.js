...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/brynmarier.github.io/ebook-site/flexsearch.min.js');loadScript('/brynmarier.github.io/ebook-site/en.search-data.min.68afee672afd874ca383df83cae55ee85b89c110e4abd8c0467f9e94ff583922.js',function(){input.required=false;search();});}
